...
export class AuthService {
  ...
  async register(dto: RegisterReqDto): Promise<TokenPairResDto> {
  ...
  async login(user: User): Promise<TokenPairResDto> {
    return this.generateTokenPair(user);
  }

  async refresh(rawRefreshToken: string): Promise<TokenPairResDto> {
  ...
  async generateTokenPair(user: User): Promise<TokenPairResDto> {
